...
- [ ] Setup typography (Inter for UI, Outfit for headings).
- [ ] Create CSS variables in `index.css`.
- [ ] Setup layout components (Navbar, Footer).
...
- [ ] Simple Shopping Cart UI (Slide-out).
- [ ] Product Detail View (Quick view or separate page).

## 4. Polish & Animations
- [ ] Implement smooth scroll.
- [ ] Add reveal animations (fade-in, slide-up) using Intersection Observer.
